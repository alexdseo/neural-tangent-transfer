...
class Dataset(object):
    def __init__(self, datasource, path_data = '/content/neural-tangent-transfer/Data/', STANDARDIZE_BOOL  = True,  VALIDATION_FRACTION = 0.1, LOAD_TRAIN_PORTION = 1.0, **kwargs):
